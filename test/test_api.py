# Rename sma_charg_ctrl/__init__.py.BAK to *.bak in order to test without Homeassistant environment
import logging
...
# Normalbetrieb: 40236 = 2424 (Steuerregister) ; 40793 = 0 (laden min) ; 40795 = 2500 (laden Max) ; 40797 = 0 (entladen min) ; 40799 = 2500 (entladen Max) ; 40801 = immer 0 (Netzausgleichsleistung)
